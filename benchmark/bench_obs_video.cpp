...
static void BM_matrix4_identity(benchmark::State& state) {
    ...
    for (auto _ : state) {
        mat.x.x = 1.0f; mat.x.y = 0.0f; mat.x.z = 0.0f; mat.x.w = 0.0f;
        mat.y.x = 0.0f; mat.y.y = 1.0f; mat.y.z = 0.0f; mat.y.w = 0.0f;
        mat.z.x = 0.0f; mat.z.y = 0.0f; mat.z.z = 1.0f; mat.z.w = 0.0f;
        mat.t.x = 0.0f; mat.t.y = 0.0f; mat.t.z = 0.0f; mat.t.w = 1.0f;
